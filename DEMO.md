...
curl -s "http://127.0.0.1:8787/forecasts?limit=6" > /dev/null
...
**Say, over the output:**
> "Seventeen property tests on the engine, including Monte-Carlo recovery of a
> known volatility, and seven on the registry. Built on the official DreamDEX
